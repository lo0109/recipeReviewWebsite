      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 col-md-7 py-4">
            <h4>About</h4>
            <p class="text-body-secondary">This a website for people sharing their secret recipes.</p>
          </div>
          <div class="col-sm-4 offset-md-1 py-4">
            <h4>Contact</h4>
            <ul class="list-unstyled">
              <li><a href="https://github.com/lo0109/recipeReviewWebsite" class="text-white">Github Project Link</a></li>
...
<footer class="text-body-secondary py-5">
  <div class="container">
    ...
    <p class="mb-0">last updated on Sep 2024</p>
  </div>
</footer>
